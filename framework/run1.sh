...
# 2. Compile ton code
javac -cp "lib/gson-2.10.1.jar:lib/servlet-api.jar:lib/spring-context-6.1.14.jar:lib/spring-web-6.1.14.jar:lib/spring-beans-6.1.14.jar:lib/spring-core-6.1.14.jar:lib/spring-expression-6.1.14.jar:lib/spring-jdbc-6.1.14.jar:lib/spring-jcl-6.1.14.jar" -d bin src/utils/ModelView.java src/utils/Util.java src/utils/URLetMethodeHttps.java src/utils/ClasseMethodeMap.java src/mg/itu/URLMapping.java src/mg/itu/WebRest.java src/utils/Scannerrrs.java src/mg/itu/Controller.java src/main/java/FrontControllerServlet.java src/main/java/FrontControllerListener.java 
